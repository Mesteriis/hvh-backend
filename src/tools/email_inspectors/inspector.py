...
import httpx
import openpyxl
from rich.progress import Progress, SpinnerColumn, BarColumn, TimeElapsedColumn, ProgressColumn

from .constants import EMAIL_RE_PATTERN
from .structs import EmailList, EmailItem
...
class EmailInspector:
    ...
    def stat(self):
        stat = {
            "input data": self._collect_input_stat(),
            "verified": self._collect_verified_stat()
        }
