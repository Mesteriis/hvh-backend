...
Revision ID: e77e2a413a84
Revises: 
Create Date: 2024-08-07 19:14:10.994496
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('new', 'pending', 'in_progress', 'completed', 'failed', name='statusenum'), nullable=False),
    ...
    op.create_index(op.f('ix_channels_ext_id'), 'channels', ['ext_id'], unique=True)
    ...
    op.create_index(op.f('ix_playlists_ext_id'), 'playlists', ['ext_id'], unique=True)
    ...
    op.create_index(op.f('ix_videos_ext_id'), 'videos', ['ext_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_videos_ext_id'), table_name='videos')
    op.drop_table('videos')
    op.drop_index(op.f('ix_playlists_status'), table_name='playlists')
    op.drop_index(op.f('ix_playlists_ext_id'), table_name='playlists')
    op.drop_table('playlists')
    op.drop_index(op.f('ix_channels_status'), table_name='channels')
    op.drop_index(op.f('ix_channels_ext_id'), table_name='channels')
